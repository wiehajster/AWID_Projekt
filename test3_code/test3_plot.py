...
plt.xscale("log")
plt.grid()
plt.savefig(output_dir.joinpath("test3_time.png"), bbox_inches="tight", pad_inches=0)
...
plt.xscale("log")
plt.grid()
plt.savefig(output_dir.joinpath("test3_memory.png"), bbox_inches="tight", pad_inches=0)
...
plt.grid()
plt.savefig(
    output_dir.joinpath("test3_memory_python.png"), bbox_inches="tight", pad_inches=0
)
...
plt.xscale("log")
plt.grid()
plt.savefig(output_dir.joinpath("test3_allocs.png"), bbox_inches="tight", pad_inches=0)
...
plt.grid()
plt.savefig(
    output_dir.joinpath("test3_accuracy.png"), bbox_inches="tight", pad_inches=0
)
