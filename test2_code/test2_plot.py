...
plt.xscale("log")
plt.grid()
plt.savefig(output_dir.joinpath("test2_time.png"), bbox_inches="tight", pad_inches=0)
...
plt.xscale("log")
plt.grid()
plt.savefig(output_dir.joinpath("test2_memory.png"), bbox_inches="tight", pad_inches=0)
...
plt.grid()
plt.savefig(
    output_dir.joinpath("test2_memory_python.png"), bbox_inches="tight", pad_inches=0
)
...
plt.xscale("log")
plt.grid()
plt.savefig(output_dir.joinpath("test2_allocs.png"), bbox_inches="tight", pad_inches=0)
...
plt.grid()
plt.savefig(
    output_dir.joinpath("test2_accuracy.png"), bbox_inches="tight", pad_inches=0
)
